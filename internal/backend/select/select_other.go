...
// newBackend refuses: monmux wraps ddcutil on Linux and m1ddc on macOS, and has
// nothing to wrap anywhere else.
//
...
func newBackend(_ Options) (backend.Backend, error) {
	return nil, refusal.New(
		...
		"monmux supports Linux (ddcutil) and macOS (m1ddc); this is "+runtime.GOOS+".",
	)
}
